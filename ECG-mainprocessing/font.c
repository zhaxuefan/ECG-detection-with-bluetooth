...
/*const unsigned char gImage_hhh[38400] = {// 0X00,0X10,0X78,0X00,0XA0,0X00,0X01,0X1B, //

};
*/

const unsigned char gImage_hhh0[1] = {0x00};

const unsigned char gImage_hhh1[1] = {0x1F};

/*
const unsigned char gImage_hhh2[255] = {
...
0XF2,0XF3,0XF4,0XF5,0XF6,0XF7,0XF8,0XF9,0XFA,0XFB,0XFC,0XFE,0XFE,
